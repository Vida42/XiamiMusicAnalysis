...
def crawl():
    ...
    try:
        ...
        for tag in soup.find_all('div',id='sidebar'): 
            for each in tag.find_all('a'):
                genre = each['href'].strip()
                genre_name = each.get_text()
                print(genre)
                print(genre_name)
                with open('result.txt', 'a', encoding="UTF-8") as f:
                    f.write(genre + '\t' + genre_name + '\n')
